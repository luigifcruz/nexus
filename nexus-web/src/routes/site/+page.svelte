<script lang="ts">
    ...
    let cameras = $state([
        {
            id: "main",
            name: "Main Site View",
            url: "http://10.3.0.30/mjpg/video.mjpg",
            selected: true,
        },
        {
            id: "lab1",
            name: "Lab 1 View",
            url: "http://10.3.0.28/mjpg/video.mjpg",
            selected: false,
        },
        {
            id: "lab2",
            name: "Lab 2 View",
            url: "http://10.3.0.29/mjpg/video.mjpg",
            selected: false,
        },
    ]);
    ...
    let weatherData = $state({
        ...
        advisory:
            "Winter Storm Watch in effect from Thursday evening through Friday morning. Heavy snow possible with accumulations of 6-12 inches.",
    });
...
<svelte:head>
    <title>Nexus - Site Overview</title>
</svelte:head>
...
{#if mounted}
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">
                        Live view of the Allen Telescope Array site and current
                        weather conditions
                    </p>
                </div>
            </div>
                    ...
                    <Card.Root>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <DropdownMenu.Root>
                                    ...
                                    <DropdownMenu.Content>
                                        <DropdownMenu.Label
                                            >Select Cameras</DropdownMenu.Label
                                        >
                        ...
                        <Card.Content>
                            {#if selectedCameras.length === 0}
                                <div
                                    class="relative aspect-video bg-muted rounded-lg overflow-hidden"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <p class="text-sm text-center">
                                            Please select one or more cameras
                            ...
                            {:else}
                                <div
                                    class="grid gap-4 {selectedCameras.length ===
                                    1
                                        ? ''
                                ...
                                >
                                    {#each selectedCameras as camera (camera.id)}
                                        <div
                                            class="{selectedCameras.length === 1
                                                ? 'aspect-video'
                                                : 'aspect-[4/3]'} bg-muted rounded-lg overflow-hidden"
                                        >
                                            <CameraVideo
                                                {camera}
                    ...
                    <Card.Root class="h-full">
                        ...
                        <Card.Content class="space-y-4">
                            ...
                            <div class="text-center py-1">
                                ...
                                <Badge
                                    variant={weatherData.observingConditions ===
                                    "Excellent"
                                        ? "default"
                            ...
                            {#if weatherData.advisory}
                                <div class="space-y-2">
                                    <div
                                        class="flex items-center gap-2 p-3 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800"
                                    >
                                        <AlertTriangleIcon
                                            class="h-4 w-4 text-yellow-600 dark:text-yellow-500 shrink-0"
                                        />
                                        <div
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div
                                    class="flex items-center gap-2 p-3 rounded-xl bg-muted/50"
                                >
                                    <DropletIcon
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="space-y-2">
                                    {#each weatherForecast.slice(0, 5) as day}
                                        <div
                                            class="flex items-center gap-2 p-3 rounded-xl bg-muted/50 {day.condition ===
                                                'Heavy Rain' ||
                                            day.condition === 'Snow'
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {:else if day.icon === "snow"}
                                                    <SnowflakeIcon
                                                        class="h-4 w-4 text-blue-300 dark:text-blue-400"
                                                    />
                                                {/if}
                                                <span
    ...
    {#if maximizedCamera}
        ...
        >
            <div
                class="relative w-full h-full max-w-6xl max-h-[90vh] bg-background rounded-lg overflow-hidden"
